...
# debug flags #
DBG_FLAGS = -Wall -Wextra -O0 -g3 -ggdb -fmax-errors=1 -fno-omit-frame-pointer -fno-inline# $(SANATIZE_FLAGS)
# opt flags #
...
INCLUDES = -I./include/ -I$(HOME)/.local/include -I./plog/include -I./autodiff/autodiff
...
LIBS = -lm -lboost_program_options -lyaml-cpp 
